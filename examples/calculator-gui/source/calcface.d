...
struct CalcFace
{
    ...
    void build(){
        ...
        buttons[0].setBezelStyle(NSRoundedBezelStyle);
        buttons[0].setTag(0);
        ...
        buttons[1].setBezelStyle(NSRoundedBezelStyle);
        buttons[1].setTag(1);
        ...
        buttons[2].setBezelStyle(NSRoundedBezelStyle);
        buttons[2].setTag(2);
        ...
        buttons[3].setBezelStyle(NSRoundedBezelStyle);
        buttons[3].setTag(3);
        ...
        buttons[4].setBezelStyle(NSRoundedBezelStyle);
        buttons[4].setTag(4);
        ...
        buttons[5].setBezelStyle(NSRoundedBezelStyle);
        buttons[5].setTag(5);
        ...
        buttons[6].setBezelStyle(NSRoundedBezelStyle);
        buttons[6].setTag(6);
        ...
        buttons[7].setBezelStyle(NSRoundedBezelStyle);
        buttons[7].setTag(7);
        ...
        buttons[8].setBezelStyle(NSRoundedBezelStyle);
        buttons[8].setTag(8);
        ...
        buttons[9].setBezelStyle(NSRoundedBezelStyle);
        buttons[9].setTag(9);
        ...
        buttons[10].setBezelStyle(NSRoundedBezelStyle);
        ...
        buttons[11].setBezelStyle(NSRoundedBezelStyle);
        ...
        buttons[12].setBezelStyle(NSRoundedBezelStyle);
        ...
        buttons[13].setBezelStyle(NSRoundedBezelStyle);
        ...
        buttons[14].setBezelStyle(NSRoundedBezelStyle);
        ...
        buttons[15].setBezelStyle(NSRoundedBezelStyle);
        ...
        buttons[16].setBezelStyle(NSRoundedBezelStyle);
        ...
        buttons[17].setBezelStyle(NSRoundedBezelStyle);
